...
** For more details, visit https://github.com/jhjacobsen/invertible-resnet **
"""
import torch
...
class SpectralNorm(object):
    ...
    def _solve_v_and_rescale(self, weight_mat, u, target_sigma):
        ...
        # This uses p^inverse in case W^T W is not invertible.
...
def remove_spectral_norm(module, name='weight'):
    r"""Removes the spectral normalization reparametrization from a module.
